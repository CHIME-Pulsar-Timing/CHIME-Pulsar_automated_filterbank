...
if cur_option == '1':
    ...
    str_input = input("enter the rank(s) of key SPEG(s) (separated by comma): ")
    SPEGs_included_ranks = list(map(int, str_input.split(',')))
    ...
    excluded_SPEG_rank = int(input("enter the rank of the SPEG to be excluded: "))
    ...
    if spe_number > 2:
        ...
        for subset_size in reversed(list(range(3, spe_number + 1))):
...
# find the periodicity of a subset of specified  SPEGs
    ...
    str_input = input("enter the ranks of SPEGs of interest (separated by comma): ")
    SPEGs_included_ranks = list(map(int, str_input.split(',')))
...
# verify all SPEGs with known period and known true spes
    ...
    str_input = input("enter the rank(s) of two SPEG(s) to be confirmed (separated by comma): ")
    ...
    str_input2 = input("Enter the predefined period: ")
    ...
    str_input3 = input("Do you want to check all SPEGs or just check some SPEGs? Input all or some.")
    if str_input3 == "all":
        ...
        str_input4 = input("which SPEG(s) do you want to verify? ")

        other_SPEGs = list(map(int, str_input4.split(',')))
        other_SPEGs.sort()
        # sort in ascending order
